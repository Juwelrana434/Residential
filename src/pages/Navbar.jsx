...
const navlink = <>
 ...
 <li><NavLink to='/career'>About</NavLink></li>
  ...
  <div className="navbar-start">
    ...
    <a className="btn btn-ghost lg:text-2xl sm:text-sm"><span className="text-[#236028] font-bold flex items-center leading-none"> <IoMdHome className='lg:text-4xl text-[#64cb10] md:text-2xl'/>House <br />Of Peace</span></a>
  </div>
