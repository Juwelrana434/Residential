    ...
    <div>
      ...
      <div className="grid lg:md:grid-cols-2 gap-6 p-4 my-6">
        <div className="text-left lg:md:mt-20">
          <h1>About us</h1>
          <h1 className="lg:md:text-5xl font-bold my-6 text-2xl animate__animated animate__bounce animate__delay-2s animate__repeat-3	3">
          ...
          <div className="text-left my-4">
            <li className="animate__animated animate__bounce animate__repeat-1">Tailored Excellence​</li>
            <li className="animate__animated animate__bounce animate__repeat-2">Tailored Excellence​</li>
            <li className="animate__animated animate__bounce animate__repeat-3">Innovative Designs​</li>
          </div>
      ...
      <div className="grid lg:md:grid-cols-2 gap-6 text-left">
        <div className="border-2 rounded-md border-gray-100 p-4 shadow-md">
          <div id="left-side/up">
            <img data-aos="zoom-in" data-aos-duration="1000" className="w-full h-[320px]" src={Home8} />
        ...
        <div className="border-2 rounded-md border-gray-100 p-4 shadow-md">
          <div id="left-side/up">
            <img data-aos="zoom-in-down" data-aos-duration="1000" className="w-full h-[320px]" src={Home9} />
        ...
        <div className="border-2 rounded-md border-gray-100 p-4 shadow-md">
          <div id="left-side/up">
            <img data-aos="zoom-in-down" data-aos-duration="1000" className="w-full h-[320px]" src={Home10} />
        ...
        <div className="border-2 rounded-md border-gray-100 p-4 shadow-md">
          <div id="left-side/up">
            <img data-aos="zoom-in-down" data-aos-duration="1000" className="w-full h-[320px]" src={Home11} />
            <h1 className="text-2xl font-bold my-4">
              Green Living Solutions​​​​</h1>
            <p className="text-[20px]">
...
{/* our project section  */}
      <div className="text-center mt-6">
        <h1>OUR PROJECTS</h1>
        <h1 className="text-3xl font-bold my-4 animate__animated animate__bounce animate__repeat-2">A Task Approached With Great Commitment</h1>
        <h1 className="my-6">
      ...
      <div className="mb-20"><div className="grid lg:md:grid-cols-3 gap-6 my-6">
        <div>
          {" "}
          <img data-aos="zoom-in-down" data-aos-duration="1000" src={Home12} className="rounded-t-full h-full border-gray-100 p-4 shadow-md" />
          <h1 className="text-xl font-medium my-1">Urban Oasis Residence</h1>
          <h1>Downtown Loft, New York</h1>
        </div>
        <div className="">
          {" "}
          <img data-aos="zoom-in-down" data-aos-duration="1000" src={Home13} className="rounded-t-full h-full border-gray-100 p-4 shadow-md" />
          <h1 className="text-xl font-medium my-1">Urban Oasis Residence</h1>
          <h1>Downtown Loft, New York</h1>
        </div>
        <div>
          {" "}
          <img data-aos="zoom-in-down" data-aos-duration="1000" src={Home14} className="rounded-t-full h-full border-gray-100 p-4 shadow-md" />
          <h1 className="text-xl font-medium my-1">Urban Oasis Residence</h1>
